...
import 'package:dyzer/src/analyzers/unused_l10n_analyzer/unused_l10n_analyzer.dart';
import 'package:dyzer/src/analyzers/unused_l10n_analyzer/unused_l10n_config.dart';
...
void main() {
  group(
    'UnusedL10nAnalyzer',
    () {
      const analyzer = UnusedL10nAnalyzer(AnalyzerUtils());
      const rootDirectory = '';
