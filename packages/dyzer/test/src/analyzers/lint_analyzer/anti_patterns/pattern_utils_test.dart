import 'package:dyzer/src/analyzers/lint_analyzer/anti_patterns/models/pattern.dart';
import 'package:dyzer/src/analyzers/lint_analyzer/anti_patterns/pattern_utils.dart';
  ...
  group('Pattern utils', () {
    test(
      ...
      () {
        ...
        final documentationUrl = Uri.parse(
          '${EnvironmentUtils.dyzerWebUrl}/docs/anti-patterns/pattern-id',
        );
        ...
        expect(issue.codeIndex, equals(2));
      },
    );
    ...
    test('documentation returns the url with documentation', () {
      ...
      expect(
        ...
        equals(
          '${EnvironmentUtils.dyzerWebUrl}/docs/anti-patterns/$patternId1',
        ),
      );
      expect(
