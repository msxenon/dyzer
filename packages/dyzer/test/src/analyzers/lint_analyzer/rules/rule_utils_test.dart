...
import 'package:dyzer/src/analyzers/lint_analyzer/rules/models/rule.dart';
import 'package:dyzer/src/analyzers/lint_analyzer/rules/models/rule_type.dart';
import 'package:dyzer/src/analyzers/lint_analyzer/rules/rule_utils.dart';
  ...
  group('Rule utils', () {
    test(
      ...
      () {
        ...
        final documentationUrl = Uri.parse(
          '${EnvironmentUtils.dyzerWebUrl}/docs/rules/flutter/rule-id',
        );
    ...
    test('documentation returns the url with documentation', () {
      ...
      expect(
        ...
        equals(
          '${EnvironmentUtils.dyzerWebUrl}/docs/rules/flutter/$ruleId1',
        ),
      );
