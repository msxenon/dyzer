...
import 'package:dyzer/src/analyzers/unnecessary_nullable_analyzer/models/unnecessary_nullable_file_report.dart';
import 'package:dyzer/src/analyzers/unnecessary_nullable_analyzer/reporters/reporters_list/console/unnecessary_nullable_console_reporter.dart';
import 'package:dyzer/src/analyzers/unnecessary_nullable_analyzer/unnecessary_nullable_analyzer.dart';
import 'package:dyzer/src/analyzers/unnecessary_nullable_analyzer/unnecessary_nullable_config.dart';
...
void main() {
  group(
    ...
    () {
      const analyzer = UnnecessaryNullableAnalyzer(AnalyzerUtils());
      const rootDirectory = '';
