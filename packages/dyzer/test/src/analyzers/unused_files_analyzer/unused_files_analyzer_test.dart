...
import 'package:dyzer/src/analyzers/unused_files_analyzer/reporters/reporters_list/console/unused_files_console_reporter.dart';
import 'package:dyzer/src/analyzers/unused_files_analyzer/unused_files_analyzer.dart';
import 'package:dyzer/src/analyzers/unused_files_analyzer/unused_files_config.dart';
...
void main() {
  group(
    'UnusedFilesAnalyzer',
    () {
      const analyzer = UnusedFilesAnalyzer(AnalyzerUtils());
      const rootDirectory = '';
