...
import 'package:dyzer/src/analyzers/unused_code_analyzer/models/unused_code_file_report.dart';
import 'package:dyzer/src/analyzers/unused_code_analyzer/reporters/reporters_list/console/unused_code_console_reporter.dart';
import 'package:dyzer/src/analyzers/unused_code_analyzer/unused_code_analyzer.dart';
import 'package:dyzer/src/analyzers/unused_code_analyzer/unused_code_config.dart';
...
void main() {
  group(
    'UnusedCodeAnalyzer',
    () {
      const analyzer = UnusedCodeAnalyzer(AnalyzerUtils());
      const rootDirectory = '';
