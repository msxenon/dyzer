...
import 'package:dyzer/src/cli/commands/base_command.dart';
import 'package:dyzer/src/cli/exceptions/invalid_argument_exception.dart';
...
class TestCommand extends BaseCommand {
  ...
  TestCommand(this._results) : super(const AnalyzerUtils());
