...
abstract class HtmlReporter<T extends FileReport, P> extends Reporter<T, P> {
  ...
  Future<void> copyResources() async {
    const resources = [
      'package:dyzer/src/reporters/resources/variables.css',
      'package:dyzer/src/reporters/resources/normalize.css',
      'package:dyzer/src/reporters/resources/base.css',
      'package:dyzer/src/reporters/resources/main.css',
    ];
