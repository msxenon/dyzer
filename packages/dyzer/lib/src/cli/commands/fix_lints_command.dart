...
class FixLintsCommand extends BaseCommand {
  late final LintAnalyzer _analyzer =
      LintAnalyzer(_logger, skipBaseline: false);
  ...
  FixLintsCommand(super.analyzerUtils, this._logger) {
    _addFlags();
  }
