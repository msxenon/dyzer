// ignore_for_file: inference_failure_on_untyped_parameter, type_annotate_public_apis, prefer_expression_function_bodies, avoid_dynamic_calls
...
/// └──────────────────────────
/// ```
class DyzerPrettyPrinter extends LogPrinter {
  ...
  bool _isInExcludePaths(String segment) {
    for (final element in excludePaths) {
  ...
  String toEncodableFallback(object) {
  ...
  String _getEmoji(Level level) {
    if (printEmojis) {
      final emoji = levelEmojis?[level] ?? defaultLevelEmojis[level];
      if (emoji != null) {
        return '$emoji ';
      }
    }
